...
1. 正確答案是什麼。
2. 為什麼正確答案是這個。
3. 若是選擇題，請逐一說明其他選項錯在哪裡。
4. 說明本題核心知識點。
5. 文字要清楚、簡潔，適合考前複習。
6. 如果原題有圖片，詳解要呼應圖片內容。
7. 如果原始答案疑似有誤，不要擅自更改答案，請在 explanation 中註明「疑似答案需人工確認」。

詳解風格範例：

本題答案為 B。MRP 是 Material Requirements Planning，主要用來依據主生產排程與物料清單計算未來所需物料的數量與時間，因此 B 正確。A 只描述庫存查詢，範圍過窄；C 偏向財務管理；D 與人事管理有關，皆不是 MRP 的主要目的。
